...
export class SellersRepository {
    constructor(
        ...
        async findOne(sellerFilterQuery: FilterQuery<Seller>): Promise<Seller> {
            return (await this.sellersModel.findOne(sellerFilterQuery).populate('products').exec());
        }
        ...
        async deleteOne(sellerFilterQuery: FilterQuery<Seller>): Promise<{ success: boolean }> {
